...
const LoginPage = () => {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast.success('Welcome back! Redirecting to AI Lab...');
  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4 ancient-glyph relative overflow-hidden">
      {/* Background effects */}
      ...
      >
        <div className="glass-effect p-8 rounded-2xl border border-primary/30">
          ...
          <p className="text-center mt-6 text-gray-400">
            ...
            <Link href="/signup" className="text-primary hover:text-primary-light transition-colors duration-300">
              Sign up
            </Link>
          </p>
        </div>
